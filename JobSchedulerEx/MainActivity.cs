...
namespace JobSchedulerEx
{
    ...
    {
        private Button _startJobButton;
        private Button _stotJobButton;
        ...
        {
            _startJobButton = FindViewById<Button>(Resource.Id.button1);
            _stotJobButton = FindViewById<Button>(Resource.Id.btn1);

        }

        private void UIClickEvents()
        {
            _startJobButton.Click += _startButton_Click;
            _stotJobButton.Click += _stopButton_Click;
        }
        ...
        {
            _jobInfoBuilder = this.CreateJobBuilderUsingJobId<UploadImage>(1)
